    ...
    <div>
      ...
      <ol>
        <li><strong>Observation and Causation:</strong>
          <ul>
            <li>The diagram starts with "Observational data(effects) X" in blue, representing the data that we can observe directly. This is typically what we gather from experiments, surveys, or real-world data collection.</li>
            <li>There are two types of causes shown: "Explicit causes Y" and "Latent causes E". The explicit causes (Y) are known and can be directly observed or measured. The latent causes (E), shown in a separate bubble, are hidden or unobserved factors that can also influence the observational data.</li>
          </ul>
        </li>

        <li><strong>Causal Relationships:</strong>
          <ul>
            <li>Arrows from both "Explicit causes Y" and "Latent causes E" point towards "Observational data X", indicating that both explicit and latent causes influence the data we observe.</li>
          </ul>
        </li>
        ...
        <li><strong>Label and Observation Spaces:</strong>
          <ul>
            <li>The "Label space Y" and " Observation space X" are the domains in which the explicit causes and observational data exist, respectively. These are the outputs and inputs of the model in terms of data representation.</li>
          </ul>
        </li>
      </ol>
